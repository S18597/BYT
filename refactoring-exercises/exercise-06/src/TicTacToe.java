public class TicTacToe {
	...
	public char winner() {
		if(checkForHorizontal()!='0') return checkForHorizontal();
		if(checkForVertical()!='0') return checkForVertical();
		if(checkForDiagonal()!='0') return checkForDiagonal();
		return '0';
	}

	// check for horizontal winner
	public char checkForHorizontal(){
		for (int i = 0; i < 9; i += 3) {
			if (board.charAt(i) != '-'
