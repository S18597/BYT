...
public class Money implements Comparable {
	...
	public String toString() {
		return String.format("%.2f",this.getAmount()/100.00) + " " + this.getCurrency().getName();
	}
	...
	public Integer universalValue() {
		return this.getCurrency().universalValue(this.amount);
	}
	...
	public Money add(Money other) {
		Integer converted = this.getCurrency().valueInThisCurrency(other.getAmount(), other.getCurrency());
		return new Money(converted  + this.getAmount(), this.getCurrency());
	}
	...
	public Money sub(Money other) {
		Integer converted = this.getCurrency().valueInThisCurrency(other.getAmount(), other.getCurrency());
		return new Money(this.getAmount() - converted, this.getCurrency());
	}
	...
	public int compareTo(Object other) {
		...
		Integer otherMoneyConverted = otherMoney.universalValue();
		Integer thisMoneyConverted = this.universalValue();
		if(otherMoneyConverted.equals(thisMoneyConverted)){
			return 0;
		}else if(thisMoneyConverted < otherMoneyConverted){
			return -1;
		}else {
			return 1;
		}
